...
import { ShoppingCartFuncContextType, RawProductObjectType, BasketProductObjectType } from "../../Types/ShoppingCartTypes";


export const ShoppingCartFunc = createContext<ShoppingCartFuncContextType>({} as ShoppingCartFuncContextType);
...
export const ShoppingCartProvider = (props: any) => {
  ...
  const funcs: any = {
    ...
    handleDirectAmountInput: (product: BasketProductObjectType, amount: number) => {
      const doesExist:any = cartProducts.find(
        (item) =>
          item.ProductName === product.ProductName &&
          item.ProductIndex === product.ProductIndex &&
