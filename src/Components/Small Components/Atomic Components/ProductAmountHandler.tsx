...
export default function ProductAmountHandler(props: ProductAmountHandlerPropsType) {
  const { product } = props;
  ...
  const handleUserDirectInput = (product: BasketProductObjectType, amount:number) => {
