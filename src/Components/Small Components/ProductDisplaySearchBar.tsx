...
export default React.memo(function ProductSearchBar({ product, addProduct }: ProductSearchBarProps) {
  ...
  const [variationAndPrice, setVariationAndPrice] = useState<RawProductObjectType[]>([]);
